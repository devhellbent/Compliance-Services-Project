...
export const SERVICE_APPENDIX_SEGMENTS: Record<string, string[]> = {
  ...
  // Documentations — Free Legal Documents.docx (verbatim extract)
  "income-certificate": freeLegalDocumentsSource,
  "no-objection-certificate": freeLegalDocumentsSource,
  "consultancy-agreement": freeLegalDocumentsSource,
  "finance-agreement": freeLegalDocumentsSource,
  "franchise-agreement": freeLegalDocumentsSource,
  "joint-venture-agreement": freeLegalDocumentsSource,
  "master-service-agreement": freeLegalDocumentsSource,
  "scope-of-work-agreement": freeLegalDocumentsSource,
  "service-level-agreement": freeLegalDocumentsSource,
  "succession-certificate": freeLegalDocumentsSource,
  "vendor-agreement": freeLegalDocumentsSource,
  "noncompete-agreement": freeLegalDocumentsSource,
  "gift-deed": freeLegalDocumentsSource,
  "sale-deed": freeLegalDocumentsSource,
  "rental-tenant-notice": freeLegalDocumentsSource,
  "legal-notice": freeLegalDocumentsSource,
  "probate-of-will": freeLegalDocumentsSource,
  "will-registration": freeLegalDocumentsSource,
  "payroll-maintenance": freeLegalDocumentsSource,

  "all-legal-documents": freeLegalDocumentsSource,
  "commercial-rental-agreement": freeLegalDocumentsSource,
  "experience-letter": freeLegalDocumentsSource,
  "appointment-letter": freeLegalDocumentsSource,
  "affidavit-format": freeLegalDocumentsSource,
  "salary-slip": freeLegalDocumentsSource,
  "resignation-letter": freeLegalDocumentsSource,
  "legal-heir-certificate": freeLegalDocumentsSource,
  "relieving-letter": freeLegalDocumentsSource,
  "partnership-deed": freeLegalDocumentsSource,
  "gst-invoice": freeLegalDocumentsSource,
  "authorised-signatory-in-gst": freeLegalDocumentsSource,
  "delivery-challan": freeLegalDocumentsSource,
  "offer-letter": freeLegalDocumentsSource,
  "rent-receipt": freeLegalDocumentsSource,
  "non-disclosure-agreement-nda": freeLegalDocumentsSource,
  "shareholders-agreement": freeLegalDocumentsSource,
  "memorandum-of-understanding": freeLegalDocumentsSource,
  "share-purchase-agreement": freeLegalDocumentsSource,
  "power-of-attorney": freeLegalDocumentsSource,
  "rental-agreement": freeLegalDocumentsSource,
  "employment-agreement": freeLegalDocumentsSource,
  esop: freeLegalDocumentsSource,
};
