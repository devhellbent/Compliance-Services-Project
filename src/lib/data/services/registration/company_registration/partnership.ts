  ...
  advantages: [
    {
      ...
      text: "Ability to Sue: A registered firm and its partners have the legal right to file a lawsuit against a third party or other partners to enforce a right arising from a contract. An unregistered firm does not have this right. Legal Standing: Registration gives the firm a legal identity, enhancing its credibility.",
    },
    {
      icon: "Landmark",
      title: "Access to Financial and Business Opportunities",
      text: "Raising Capital: Registered firms are more likely to secure loans and credit facilities from banks and financial institutions. Business Expansion: A registered firm can enter into contracts, acquire assets, and engage in legal transactions in its own name.",
    },
    {
      icon: "FileCheck",
      title: "Dispute Resolution",
      text: "Internal Disputes: The registration process involves a partnership deed, a legally binding document that outlines the rights, duties, and responsibilities of each partner. This serves as a clear reference for resolving internal conflicts and misunderstandings.",
    },
    {
      icon: "Receipt",
      title: "Tax Benefits and Compliance",
      text: "Tax Advantages: Registered firms are eligible for various tax benefits, deductions, and exemptions. Easier Conversion: A registered partnership can be more easily converted into a different business structure, such as a Limited Liability Partnership (LLP) or a private limited company.",
    },
    {
      icon: "Users",
      title: "Partner Protection and Continuity",
      text: "Clear Ownership and Liability: The partnership deed provides clear documentation of the capital contributions, profit-sharing ratio, and liability of each partner. Business Continuity: A registered firm can include provisions for the seamless admission of new partners or withdrawal of existing ones.",
    },
  ],
  disadvantages: [
    {
      icon: "AlertTriangle",
      title: "Unlimited Liability",
      text: "The biggest drawback is that partners in a general partnership have unlimited liability. This means their personal assets can be used to pay off the firm's debts and obligations if the business fails.",
    },
    {
      icon: "Clock",
    ...
    },
    {
      ...
      text: "A partnership firm is limited to a maximum of 20 partners, which can restrict business expansion in some cases.",
    },
  ],
  eligibility: [
